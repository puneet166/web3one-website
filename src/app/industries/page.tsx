...
const industries = [
  {
    ...
    description:
      "End-to-end protocol engineering from architecture design to mainnet launch.",
    outcomes: [
      "Layer 1 & Layer 2 architecture",
      "Tokenomics & validator systems",
      "Staking & governance frameworks",
  ...
  },
  {
    ...
    description:
      "Compliance-aware blockchain systems for financial institutions entering Web3.",
    outcomes: [
      "RWA tokenization platforms",
      "Custody-integrated systems",
  ...
  },
  {
    ...
    description:
      "High-performance trading infrastructure built for scale and liquidity.",
    outcomes: [
      "CEX & DEX development",
  ...
  },
  {
    ...
    description:
      "Institutional-grade infrastructure for digitizing real-world assets.",
    outcomes: [
  ...
  },
  {
    ...
    description:
      "Blockchain backend systems powering digital economies and NFT ecosystems.",
    outcomes: [
      "Play-to-earn token systems",
      "NFT marketplace architecture",
      "On-chain asset mechanics",
      "Scalable gaming backends",
    ],
  },
  {
    title: "Enterprise & Government",
    description:
      "Private and permissioned blockchain deployments for institutional environments.",
    outcomes: [
      "Identity & credential systems",
      "Private chain deployment",
      "Distributed ledger integrations",
      "Secure public-sector architecture",
    ],
  },
]
