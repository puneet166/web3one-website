          ...
          {reasons.map((reason, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -6 }}
                className="group p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-300 hover:border-purple-500/40 hover:bg-white/10"
              >
                {/* Icon */}
